...
export const metadata = {
  title: "Nutrición | Fitness&Fogón Blog",
  description: "Artículos científicos sobre nutrición, dietas y alimentación saludable",
}

export default function NutricionPage() {
  const posts = getBlogPostsByCategory("nutricion")

  return (
    <div className="min-h-screen bg-black">
      {/* Hero */}
      <div className="bg-gradient-to-b from-primary/20 to-black py-20 md:py-32">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="font-serif text-5xl md:text-6xl font-bold text-primary">Nutrición</h1>
          </div>

          <p className="text-xl text-foreground/80 max-w-3xl">
            Descubre la ciencia detrás de la alimentación. Artículos basados en evidencia sobre dietas, macros,
            suplementos y estrategias nutricionales para optimizar tu salud y rendimiento.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {posts.map((post) => (
            <Link key={post.slug} href={`/blog/${post.slug}`}>
              <Card className="bg-card border-border hover:border-primary transition-all duration-300 hover:shadow-xl hover:shadow-primary/20 group h-full">
